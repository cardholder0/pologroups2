...
class Evisa_Funfact extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            'box_border_color',
            [
                'label' => esc_html__('Box Border Color', 'xpress-core'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .xb-counter .xb-item--number' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .xb-counter .xb-item--title',
            ]
        );
        $this->add_control(
            'title_hr',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .xb-counter .xb-item--title' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .xb-counter .xb-item--title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        <div class="xb-counter ul_li">
            ...
            foreach ($settings['lists'] as $list):
                ?>
                <div class="xb-item--item ul_li elementor-repeater-item-<?php echo esc_attr($list['_id']) ?>">
                    ...
                    <div class="xb-item--holder">
                        ...
                        <?php if (!empty($list['title'])): ?>
                            <h5 class="xb-item--title"><?php echo esc_html($list['title']); ?></h5>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endforeach; ?>
...
Plugin::instance()->widgets_manager->register(new Evisa_Funfact());