...
class Evisa_Hero_one extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .xb-list li' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
    ...
    protected function render()
    {
        ...
        <section class="hero hero__style-one bg_img" <?php if (!empty($settings['bg_image']['url'])): ?>
                    ...
                    <div class="col-xl-6 col-lg-7">
                        <div class="hero__content">
                            <?php if (!empty($settings['title'])): ?>
                                <h1 class="wow skewIn"><?php echo wp_kses($settings['title'], true); ?></h1>
                            <?php endif; ?>
                            <?php if (!empty($settings['content'])): ?>
                                <p class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration=".6s"><?php echo wp_kses($settings['content'], true); ?></p>
                            <?php endif; ?>
...
Plugin::instance()->widgets_manager->register(new Evisa_Hero_one());