<?php
/**
 *evisa Bootstrap Navwalker
 *
 * @packageevisa-Bootstrap-Navwalker
 *
 */

// Check if Class Exists.
if ( ! class_exists( 'Evisa_Bootstrap_Navwalker' ) ) {
	/**
	 * Evisa_Bootstrap_Navwalker class.
	 */
	class Evisa_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'evisa' ) . '">' . esc_html__( 'Add a menu', 'evisa' ) . '</a></li>';
			$fallback_output .= '</ul>';
