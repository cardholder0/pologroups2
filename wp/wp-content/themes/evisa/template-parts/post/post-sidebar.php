<?php
if(is_archive()){
	$page_layout = evisa_option('archive_layout', 'right-sidebar');
}else if(is_search()){
	$page_layout = evisa_option('search_layout', 'right-sidebar');
}else{
	$page_layout = evisa_option('blog_layout', 'right-sidebar');
}
